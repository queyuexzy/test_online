...
//		mailInfo.setFromAddress("queyuexzy@163.com");
//		mailInfo.setUserName("queyuexzy");
//		mailInfo.setPassword("xzy15832812757");
//		String[] toAddress = {"1143649536@qq.com"};
...
//		mailHelper.sendTextMail(mailInfo);
		 ...
		 MailHelper.sendMail("1143649536@qq.com", "123");
	}
	 
	 public static void sendMail(String toAddress,String content) throws MessagingException{
		 	MailInfo mailInfo = new MailInfo();
			mailInfo.setMailServerHost("smtp.163.com");
			mailInfo.setMailServerPort("25");
			mailInfo.setFromAddress("queyuexzy@163.com");
