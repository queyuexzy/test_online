...
public final class AjaxResponse {
	...
	public static final AjaxErrorCode AJAX_CODE_ID_AND_PASSWORD_NOT_MATCH = new AjaxErrorCode(
			-205, "id和密码不符", AjaxErrorCode.ACTION_CODE);
